...
hiRegitDetachedTripletStepSeeds.RegionFactoryPSet.RegionPSet.ptMin = 0.4 
hiRegitDetachedTripletStepSeeds.RegionFactoryPSet.RegionPSet.originHalfLength = 2.0
