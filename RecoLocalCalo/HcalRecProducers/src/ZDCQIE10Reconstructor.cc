...
// Class:      ZDCQIE10Reconstructor
// 
/**\class ZDCQIE10Reconstructor ZDCQIE10Reconstructor.cc RecoLocalCalo/HcalRecProducers/src/ZDCQIE10Reconstructor.cc

 Description: Phase 1 ZDC reco with QIE 10 and split-anode readout
...
class ZDCQIE10Reconstructor : public edm::stream::EDProducer<>
{
public:
    explicit ZDCQIE10Reconstructor(const edm::ParameterSet&);
    ~ZDCQIE10Reconstructor() override;
...
ZDCQIE10Reconstructor::~ZDCQIE10Reconstructor()
{
...
//
unsigned
ZDCQIE10Reconstructor::sortDataByPmt()
{
...
void
ZDCQIE10Reconstructor::fillInfos(const edm::Event& e, const edm::EventSetup& eventSetup)
{
    using namespace edm;
...
std::cout<<"in fillinfos: get here 3"<<std::endl;
    ...
    if (inputSize)
    {
             ...
             it != digi->end(); ++it)
        {
            ...
            const HcalZDCDetId cell(frame.id());
...
void
ZDCQIE10Reconstructor::fillDescriptions(edm::ConfigurationDescriptions& descriptions)
{
...
DEFINE_FWK_MODULE(ZDCQIE10Reconstructor);
